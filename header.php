    ...
    <nav class="navbar navbar-expand-lg  ">
      <div class="container-fluid">
        <a class="navbar-brand" href="#">
            <img id="logo-main" src="https://sweeftdigital.com/assets/logo-white-new.svg" alt="sweeft">
            <img id="logo-main-two" src="https://sweeftdigital.com/assets/logo-black-grad.svg" alt="sweeft">
        </a>
      ...
      <!------------------- Desctop menu  ------------------>
        <div class="collapse d-flex navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0 main-navbar">
            <li class="nav-item">
              <a class="nav-link my-nav-link" aria-current="page" href="#">Services</a>
            </li>

            <li class="nav-item">
              <a class="nav-link my-nav-link" href="#">Our work</a>
            </li>
            ...
            <li class="nav-item">
              <a class="nav-link my-nav-link" href="#">carers</a>
            </li>

            <li class="nav-item">
              <a class="nav-link my-nav-link" href="#">acceleration</a>
            </li>
      ...
      <div id="menumobile">
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
          <div class="offcanvas-header">
            ...
            <a class="navbar-brand" href="#">
              <img src="https://sweeftdigital.com/assets/logo-black-grad.svg" alt="sweeft">
            </a>
            </h5>
